...
print ("")
print ("Welcome to ATMECS payroll.")
print ("")
...
while (True):
    ...
    if user_input == 'quit':
        ...
        break
    if  not_valid_user and type(int(user_input)) == int:
        not_valid_user = False
        try:
            with open('dataset/{id}.json'.format(id = user_input)) as f:
                responses = json.load(f)
            print("")
            print ("Hi " + responses['name'] + '. How can I help you?')
            print("")
        except:
            print("")
